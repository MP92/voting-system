...
public class RestaurantTestData {
    ...
    public static final List<Restaurant> ALL_RESTAURANTS = Arrays.asList(getWithoutMenu(RESTAURANT_1), getWithoutMenu(RESTAURANT_2));
    ...
    public static class TestRestaurantFactory {
        ...
        public static Restaurant getWithoutMenu(Restaurant r) {
            return new Restaurant(r.getId(), r.getName(), r.getDescription(), r.getAddress(), r.getPhoneNumber());
        }
    }
}
